...
@register_model('summarization_mass')
class SummarizationMASSModel(FairseqEncoderDecoderModel):
    """
    Args:
...
@register_model_architecture('summarization_mass', 'summarization_mass')
...
@register_model_architecture('summarization_mass', 'summarization_mass_base')
...
@register_model_architecture('summarization_mass', 'summarization_mass_big')
